...
describe('suppression elite', () => {
	it('applies its configured suppression only inside the aura without stacking copies', () => {
		...
		if (!second) {
			throw new Error('Expected a second suppression elite');
		}
