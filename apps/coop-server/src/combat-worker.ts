...
import type { CombatWorkerRequest, CombatWorkerResponse } from '@prism-bastion/coop/simulation';

const port = parentPort;
if (!port) {
	throw new Error('The co-op combat worker must run inside a worker thread');
}
