...
export function worldPointToBattlefieldOverlay(viewport: OverlayViewport, point: Point): Point {
...
export function TowerLoadoutOverlay({ engine, towers }: { engine: GameEngine; towers: readonly Tower[] }) {
