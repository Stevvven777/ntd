...
export type CombatEvent =
	| {
			readonly type: 'program-compiled';
			readonly towerId: number;
			readonly slots: readonly (ModuleId | null)[];
			readonly program: TowerProgram;
	  }
	| {
			readonly type: 'tower-cast';
			readonly towerId: number;
			readonly targetId: number | null;
			readonly shot: ShotBlueprint;
	  }
	| {
	...
	| {
			readonly type: 'projectile-absorbed';
			readonly projectileId: number;
			readonly signalId: number;
			readonly shot: ShotBlueprint;
	  }
	| {
			readonly type: 'secondary-hit';
			readonly projectileId: number;
			readonly signalId: number;
			readonly shot: ShotBlueprint;
	  }
	| {
			readonly type: 'trigger-fired';
			readonly projectileId: number;
			readonly signalId: number | null;
			readonly trigger: NonNullable<ShotBlueprint['trigger']>;
			readonly shot: ShotBlueprint;
	  }
	| {
			readonly type: 'payload-deployed';
	...
	| {
			readonly type: 'signal-leaked';
			readonly signalId: number;
			readonly signalType: SignalId;
			readonly coreDamage: number;
	  }
	| {
			readonly type: 'tower-energy-changed';
			readonly towerId: number;
			readonly before: number;
			readonly after: number;
			readonly reason: 'cast' | 'refund';
	  };
