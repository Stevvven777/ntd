...
const EmberCoatingIcon = createModuleIcon(
	<>
		<path
			className="module-icon__line"
			d="M7 21c0 5 4 8 9 8s9-3 9-8c0-7-6-10-5-17-4 3-5 7-4 11-2-2-3-4-3-7-5 4-6 8-6 13z"
		/>
		<path
			className="module-icon__fill"
			d="M12 22c0 3 2 5 4 5 3 0 5-2 5-5 0-3-3-5-3-8-3 2-2 5-4 6-1-2-1-3-1-4-1 2-1 4-1 6z"
		/>
	</>,
);
const color = '#ff8a3d';
