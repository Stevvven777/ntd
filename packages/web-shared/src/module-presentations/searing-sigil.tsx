...
const SearingSigilIcon = createModuleIcon(
	<>
		<path className="module-icon__line" d="M16 3l11 13-11 13L5 16z" />
		<path className="module-icon__fill" d="M16 8c4 5 5 8 2 12 0-3-2-4-3-6-4 4-3 9 1 10-6-1-7-6-4-10 2-2 3-4 4-6z" />
	</>,
);
const color = '#ff3d00';
	...
	statusOrbs({ id: burningEffectId, lifetime: 0.52, size: 4.1, hotColor: brightColor, bloom: 0.88 }),
	{
		...
		render: (frame, painter) => {
			...
			painter.polygon(
				frame.x,
				frame.y,
				37 - frame.easeOut(3) * 24,
				8,
				frame.rotation - frame.fin * 0.9,
				darkColor,
				frame.fout * 0.9,
				3 * frame.fout + 0.35,
			);
