...
import type { CombatSceneModel, ScenarioSignalPosition } from '@prism-bastion/game-core/game/combat-runtime';
import type { ModuleId, ProgramDiagnosticCode, SignalId } from '@prism-bastion/game-core/game/types';
import type { ModuleKind } from '@prism-bastion/game-core/modules/types';
...
export type ThoughtOverlay =
	| {
			...
			readonly target: 'tower' | { readonly towerIndex: number };
			readonly placement?: ThoughtLoadoutPlacement;
	  }
