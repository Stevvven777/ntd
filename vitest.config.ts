...
export default defineConfig({
	...
	resolve: {
		alias: [
			{
				find: /^@prism-bastion\/game-core\/(.+)$/,
				replacement: `${workspacePath('./packages/game-core/src')}/$1`,
			},
			...
			{
				find: /^@prism-bastion\/web-shared\/(.+)$/,
				replacement: `${workspacePath('./packages/web-shared/src')}/$1`,
			},
